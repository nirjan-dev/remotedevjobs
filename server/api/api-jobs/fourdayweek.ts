...
import { FourDayWeekJob } from '~~/server/api/api-jobs/JobsFromAPIs.type'
...
// const createJobFromFourDayWeekJob = async (job: FourDayWeekJob, PrismaClient: PrismaClient) => {
...
//   try {
//     companyId = await createCompanyFromFourDayWeekJob(job, PrismaClient)
...
// const createCompanyFromFourDayWeekJob = async (job: FourDayWeekJob, PrismaClient: PrismaClient) => {
